...
<div class="max-w-6xl mx-auto p-3 sm:p-6 mb-4 sm:mb-8">
	<div class="mx-2">
		...
		<div class="mb-8 flex flex-col gap-4">
			<div>
				Uw privacy is belangrijk! TRBL verwerkt daarom uitsluitend gegevens die
				nodig zijn voor (het verbeteren van) onze dienstverlening. We gaan
			...
			<div>
				...
				daarop ontsloten dienstverlening van TRBL. De ingangsdatum voor de
				geldigheid van deze voorwaarden is 04/11/2025, met het publiceren van
				een nieuwe versie vervalt de geldigheid van alle voorgaande versies. Dit
				privacybeleid beschrijft welke gegevens over u door ons worden
				...
				Als u vragen heeft over ons privacybeleid kunt u contact opnemen via <a
					class="link"
		...
		<div class="mb-8 flex flex-col gap-4">
			<div>
				...
				<div>
					...
					later moment contact met u op te nemen, vragen wij u hiervoor
					expliciet toestemming. Uw gegevens worden niet met derden gedeeld,
					anders dan om aan boekhoudkundige en overige administratieve
			...
			<div>
				...
				<div>
					In voorkomende gevallen kan TRBL op grond van een wettelijke
					...
					dergelijk geval zijn wij gedwongen uw gegevens te delen. Wij zullen
					ons echter steeds binnen de mogelijkheden die de wet ons biedt
					daartegen verzetten.
				</div>
			</div>
			...
			<div>
				...
				<div>
					...
					wij uw klantprofiel bewaren totdat u aangeeft dat u niet langer van
					onze diensten gebruik wenst te maken. Op grond van toepasselijke
					administratieve verplichtingen dienen wij facturen met uw
					(persoons)gegevens te bewaren, deze gegevens zullen dus voor zolang
					het toepasselijke termijn loopt bewaard blijven.
				</div>
			</div>

			<div>
				<h3 class="text-lg font-semibold mb-1">Uw rechten</h3>
				<div>
					Op grond van de geldende Belgische en Europese wetgeving heeft u als
					...
					beginsel sturen wij om misbruik te voorkomen afschriften en kopieën
					van uw gegevens enkel naar uw bij ons reeds bekende e-mailadres. In
					het geval dat u de gegevens op een ander e-mailadres of bijvoorbeeld
					per post wenst te ontvangen, zullen wij u vragen zich te legitimeren.
					Wij houden een administratie bij van afgehandelde verzoeken, in het
					geval van een vergeetverzoek administreren wij geanonimiseerde
					gegevens. Alle afschriften en kopieën van gegevens ontvangt u in de
			...
			<div>
				<h3 class="text-lg font-semibold mb-1">Inzagerecht</h3>
				<div>
					...
					zien. U kunt een verzoek met die strekking doen aan onze
					contactpersoon voor privacyzaken. U ontvangt dan binnen 30 dagen een
					reactie op uw verzoek. Als uw verzoek wordt ingewilligd sturen wij u
					op het bij ons bekende e-mailadres een kopie van alle gegevens met een
			...
			<div>
				<h3 class="text-lg font-semibold mb-1">Rectificatierecht</h3>
				<div>
					U heeft altijd het recht om de gegevens die wij (laten) verwerken en
			...
			<div>
				<h3 class="text-lg font-semibold mb-1">Recht op overdraagbaarheid</h3>
				<div>
					U heeft altijd het recht om de gegevens die wij (laten) verwerken en
					...
					ingewilligd sturen wij u op het bij ons bekende e-mailadres
					afschriften of kopieën van alle gegevens over u die wij hebben
					verwerkt of in opdracht van ons door andere verwerkers of derden zijn
					verwerkt. Naar alle waarschijnlijkheid kunnen wij in een dergelijk
			...
			<div>
				...
				<div>
					...
					verwerking van uw persoonsgegevens door of in opdracht van TRBL. Als u
					bezwaar maakt zullen wij onmiddellijk de gegevensverwerking staken in
					afwachting van de afhandeling van uw bezwaar. Is uw bezwaar gegrond
					dat zullen wij afschriften en/of kopieën van gegevens die wij (laten)
					verwerken aan u ter beschikking stellen en daarna de verwerking
					blijvend staken. U heeft bovendien het recht om niet aan
					geautomatiseerde individuele besluitvorming of profiling te worden
					onderworpen. Wij verwerken uw gegevens niet op zodanige wijze dat dit
					recht van toepassing is. Bent u van mening dat dit wel zo is, neem dan
		...
		<div class="mb-8 flex flex-col gap-4">
			<div>
				<div>
					Deze website maakt geen gebruik van cookies of vergelijkbare
					technieken die gegevens over uw gebruik van onze website verzamelen.
				</div>
			</div>
		</div>

		<h2 class="text-xl font-bold mb-2">Wijzigingen in het privacybeleid</h2>
		<div class="mb-8 flex flex-col gap-4">
			...
			privacybeleid gevolgen heeft voor de wijze waarop wij reeds verzamelde
			gegevens met betrekking tot u verwerken, dan brengen wij u daarvan per
			e-mail op de hoogte.
		</div>

		<h2 class="text-xl font-bold mb-2">Contactgegevens</h2>
		<div class="mb-8 flex flex-col gap-1">
			<div>TRBL</div>
			<div>Nederpolder 4</div>
			<div>9000 Gent België</div>
			<div>info@trbl.be</div>
		</div>

		<h2 class="text-xl font-bold mb-2">Contactpersoon voor privacyzaken</h2>
		<div class="mb-8 flex flex-col gap-1">
			<div>Teun Van de Voorde</div>
			<a class="link" href="mailto:teun@trbl.be">teun@trbl.be</a>
		</div>
	</div>
</div>
