			...
			<div style="padding: 40px;">
				...
				<div style="margin: 30px 0;">
					...
					<div style="background-color: #f8f9fa; padding: 20px; border-radius: 6px;">
						...
						<p style="color: #333333; font-size: 14px; margin: 0 0 10px 0;">
							<strong>Land:</strong> ${mapCountryCodeToName(invoiceMessage.country)}
						</p>
						<p style="color: #333333; font-size: 14px; margin: 0 0 10px 0;">
	...
	<body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f4f4f4; line-height: 1.6;">
		<div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 0; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
			...
			<div style="padding: 40px;">
				...
				<p style="color: #555555; font-size: 16px; margin: 0 0 20px 0;">
					Beste ${invoiceMessage.firstName},
				</p>
				...
				<div style="margin: 30px 0;">
					...
					<div style="background-color: #f8f9fa; padding: 20px; border-radius: 6px;">
						...
						<div style="">
							...
							<p style="color: #888888; font-size: 12px; margin: 10px 0 0 0; font-style: italic;">
								*Dit is een schatting. U ontvangt een definitieve offerte per e-mail.
							</p>
						</div>
					</div>
				</div>
				...
				<div style="margin: 30px 0;">
					...
					<div style="background-color: #f8f9fa; padding: 20px; border-radius: 6px;">
						<p style="color: #333333; font-size: 14px; margin: 0 0 10px 0;">
							✓ Wij verwerken uw aanvraag
						</p>
						<p style="color: #333333; font-size: 14px; margin: 0 0 10px 0;">
							✓ U ontvangt binnen 1-2 werkdagen een offerte op maat
						</p>
						<p style="color: #333333; font-size: 14px; margin: 0;">
							✓ Bij akkoord regelen wij de levering of afhaling
						</p>
					</div>
				</div>
				
				<p style="color: #555555; font-size: 16px; margin: 30px 0 10px 0;">
					Heeft u nog vragen? Neem gerust contact met ons op via <a href="mailto:info@trbl.be" style="color: #007bff; text-decoration: none;">info@trbl.be</a> of bel ons.
				</p>

				<p style="color: #555555; font-size: 16px; margin: 0 0 30px 0;">
					Met vriendelijke groet,<br>
					<strong>Team TRBL</strong>
				</p>
				
				<p style="color: #888888; font-size: 14px; margin: 30px 0 0 0; text-align: center; border-top: 1px solid #f0f0f0; padding-top: 20px;">
					Deze bevestiging werd automatisch verzonden via 
					<a href="https://trbl.be" style="color: #007bff; text-decoration: none;">trbl.be</a>.
				</p>
			</div>
